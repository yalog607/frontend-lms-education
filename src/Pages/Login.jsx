      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-zinc-50 px-3 sm:px-6 lg:px-8">
        ...
        <div className="bg-base-200 p-4 sm:p-6 md:p-8 rounded-lg shadow-lg shadow-indigo-300 border border-indigo-200 w-full max-w-full sm:max-w-2xl md:max-w-4xl mt-4 sm:mt-6">
          <div className="flex flex-col md:flex-row w-full gap-4 md:gap-0">
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-3 sm:gap-4 px-4 sm:px-6 md:px-8">
              <div className="w-full flex flex-col mb-2 sm:mb-4">
                ...
                <input
                  ...
                  className={`px-3 sm:px-4 py-2 border border-gray-300 rounded-lg w-full font-semibold text-sm sm:text-md focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition ${haveValue(username) ? "border-green-500 outline-green-500" : "border-gray-300"}`}
                />
              </div>
              <div className="w-full flex flex-col relative">
                ...
                <input
                  ...
                  className={`px-3 sm:px-4 py-2 border border-gray-300 rounded-lg w-full font-semibold text-sm sm:text-md focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition ${haveValue(password) ? "border-green-500 outline-green-500" : "border-gray-300"}`}
                />
              </div>
            ...
            {/* Divider */}
            <div className="hidden md:flex divider divider-horizontal m-0 text-xs font-bold">
              OR
            </div>
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center gap-3 sm:gap-4 px-4 sm:px-6 md:px-8 md:py-0 py-4">
              ...
              <button className="btn btn-sm sm:btn-md rounded-full hover:drop-shadow-lg transition-all duration-250 bg-[#2F2F2F] text-white font-medium text-xs sm:text-sm md:text-base border-black">
                ...
                <span className="hidden sm:inline">Login with Microsoft</span>
              </button>
            </div>
          </div>
        </div>
